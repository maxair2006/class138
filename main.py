...
df.drop(columns = ['hyperlink', 'temp_planet_date',
       'temp_planet_mass', 'pl_letter', 'pl_name', 'pl_controvflag', 'pl_pnum', 'pl_orbper', 'pl_orbpererr1',
...
print(df.shape)
df =df.rename({
    'pl_hostname': 'solar_system_name', 'pl_discmethod': 'planet_discovery_method',
    'pl_orbincl': 'planet_orbital_inclination', 'pl_dens': 'planet_density', 'ra_str': 'right_ascension',
    'dec_str': 'declination', 'st_teff': 'host_temperature', 'st_mass': 'host_mass',
    'st_rad': 'host_radius'
},axis = 'columns')
print(df.columns)
